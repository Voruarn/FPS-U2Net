...
from dataset.LC8FPSDataset import LC8FPSDataset
...
def get_argparser():
    ...
    parser.add_argument("--dataset", type=str, default='LC8FPS256', help='Name of dataset')
...
def get_dataset(opts):
    train_dst = LC8FPSDataset(is_train=True,voc_dir=opts.trainset_path)
    val_dst = LC8FPSDataset(is_train=False,voc_dir=opts.testset_path)
